...
import numpy as np
from transformers import AutoTokenizer, CLIPTextModel, CLIPTextConfig, PreTrainedModel
import random
...
class SegVolGroup5(nn.Module):
    def __init__(self, 
        ...
        self.mask_decoder.predict_masks = MethodType(predict_masks_group5, self.mask_decoder)
